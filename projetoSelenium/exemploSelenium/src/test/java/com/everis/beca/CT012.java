...
public class CT012 {
	...
	@Test
	public void validarTabelaCarros() {
		navegador.findElement(By.xpath("/html/body/app/section/section/div/div[1]/div/div[2]/a[1]")).click();
		navegador.findElement(By.xpath("/html/body/app/section/section/div/div[1]/div/div[2]/ul/li[4]/a")).click();
		navegador.findElement(By.xpath("/html/body/app/section/section/div/div/div/div[3]/ul/li[14]/a")).click();
		navegador.findElement(By.xpath("/html/body/app/section/section/div/div/div/div[3]/ul/li[2]/a")).click();
		navegador.findElement(By.xpath("/html/body/app/section/section/div/div/div/div[3]/ul/li[1]/a")).click();
		navegador.findElement(By.xpath("/html/body/app/section/section/div/div/div/div[3]/ul/li[6]/a")).click();
	}
