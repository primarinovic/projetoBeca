...
public class CT011 {
	...
	@Test
	public void validarCarrossel() {
		String[] maisBuscados = { "HONDA CIVIC", "TOYOTA COROLLA", "HONDA FIT", "VOLKSWAGEN GOL", "VOLKSWAGEN GOLF",
				"VOLKSWAGEN JETTA", "CHEVROLET S10" };

		for (String elemento : maisBuscados) {
