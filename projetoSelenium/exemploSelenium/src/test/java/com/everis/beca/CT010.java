...
public class CT010 {
	...
	public void validarNav() {
		...
		navegador.findElement(By.xpath("/html/body/app/section/header/div[2]/menu/a"));

	}

	@Test
	public void validarCamposPagina() {
		String[] elementosCampos = { "Comece escolhendo o tipo de veículo", "Carro", "Motos", "Mais Buscados" };
